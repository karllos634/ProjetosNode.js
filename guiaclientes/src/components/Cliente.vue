...
export default {
    ...
    methods: {
        ...
        emitirEventoDelete: function(){
            ...
            this.$emit("meDelete",{idDoCliente: this.cliente.id, Curso: "Formação Node.js",emPromoção: true, component: this});
        },
        testar: function() {
    ...
    computed: {
        idEspecial: function(){
            return(this.cliente.email + this.cliente.noome + this.cliente.id).toUpperCase();
        }
    }
}
